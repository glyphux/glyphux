...
// internal/identity's (unexported), so these SDK-level tests can drive a
// real end-to-end MFA login without depending on identity's internals.
// Mirrors internal/api/totp_helper_test.go.
