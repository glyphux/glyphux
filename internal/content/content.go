...
// removed from the composition. This is a plain count read, not a
// capability-sensitive operation in its own right — callers that use it to
// gate a mutation (e.g. the content-type delete guard) enforce their own
